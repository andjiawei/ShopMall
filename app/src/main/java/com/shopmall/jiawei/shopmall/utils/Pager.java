package com.shopmall.jiawei.shopmall.utils;
...
/**
 * WareListActivity 请求网络及刷新的封装
 * 通过build传进来参数，OnPageListener回调给Activity
 */
public class Pager {
    ...
    private void initRefreshLayout(){
        ...
        builder.mRefreshLayout.setLoadingMoreEnabled(builder.canLoadMore);

        builder.mRefreshLayout.setLoadingListener(new XRecyclerView.LoadingListener() {
            @Override
            ...
            public void onLoadMore() {
                ...
                if(builder.pageIndex<builder.totalPage)
                    ...
                    builder.mRefreshLayout.loadMoreComplete();
                    builder.mRefreshLayout.setLoadingMoreEnabled(false);
                }
            }
        });
    }
    ...
    private <T> void showData(List<T> datas, int totalPage, int totalCount){
        ...
        if(STATE_NORMAL==state){
            ...
            builder.mRefreshLayout.refreshComplete();
            if(builder.onPageListener !=null){
    ...
    public static class Builder{
        ...
        private XRecyclerView mRefreshLayout;
        ...
        public Builder setRefreshLayout(XRecyclerView refreshLayout){
